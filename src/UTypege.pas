...
CONST
   ...
   LONG_TROTTOIR = 15;
   ESPACE_CAREFOUR = 100;
   LONG_ROUTE_X_DESIREE = 550;
   LONG_ROUTE_Y_DESIREE = 550;

   LONG_ROUTE_X = LONG_ROUTE_X_DESIREE;//ceil((LONG_ROUTE_X_DESIREE + 2.0 * LONG_TROTTOIR) / LONG_PLUS_GRAND_IMMEUBLE);
   LONG_ROUTE_Y = LONG_ROUTE_Y_DESIREE;//ceil((LONG_ROUTE_Y_DESIREE + 2.0 * LONG_TROTTOIR) / LONG_PLUS_GRAND_IMMEUBLE);
